...
def train(args):
    ...
    train_loader, test_loader = get_dataloaders(data_dir=args.data_dir, batch_size=args.batch_size, augment=not args.no_augment,)
    ...
    print(f" Best validation accuracy: {best_acc:.4f}. Model saved to {ckpt_path}.")
...
def parse_args():
    ...
    p.add_argument("--no-augment", action="store_true", help="not use data augmentation in training")
    return p.parse_args()
